...
#define HTML_HEADER "<html><head><title>Web Manager</title><script>function act(a,o,o2){document.main.action.value=a;document.main.object.value=o;document.main.object2.value=o2;document.main.submit();} \
	...
	<style> details > summary {  padding: 4px; background-color: #c0c0c0; width: 90%; border: none; box-shadow: 1px 1px 2px #bbbbbb; cursor: pointer; } \
	details > p { background-color: #cfcfcf; width: 90%; padding: 4px; margin: 0; box-shadow: 1px 1px 2px #bbbbbb; } \
	</style> \
	</head>"
